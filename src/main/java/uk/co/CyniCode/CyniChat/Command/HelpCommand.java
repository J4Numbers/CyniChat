...
public class HelpCommand {
	...
	public static boolean info( CommandSender player ) {
		...
		if ( !( player instanceof Player ) || (CyniChat.perms.checkPerm( (Player) player, "cynichat.mod.help")) ) {
			player.sendMessage("/ch help mods     -> Mod help menu");
		}
		if ( !( player instanceof Player ) || (CyniChat.perms.checkPerm( (Player) player, "cynichat.admin.help") ) ) {
			player.sendMessage("/ch help admin    -> Admin help menu");
		}
		if ( !( player instanceof Player ) || (CyniChat.perms.checkPerm( (Player) player, "cynichat.admin.reload")) ) {
