...
public class SetInviteOnlyEvent<T extends PircBotX> extends Event<T> implements GenericChannelModeEvent<T> {
	 ...
	 */
	public SetInviteOnlyEvent(T bot, Channel channel, User user) {
		super(bot);
