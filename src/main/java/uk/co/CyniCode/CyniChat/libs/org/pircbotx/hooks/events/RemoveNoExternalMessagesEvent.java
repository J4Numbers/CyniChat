...
public class RemoveNoExternalMessagesEvent<T extends PircBotX> extends Event<T> implements GenericChannelModeEvent<T> {
	 ...
	 */
	public RemoveNoExternalMessagesEvent(T bot, Channel channel, User user) {
		super(bot);
