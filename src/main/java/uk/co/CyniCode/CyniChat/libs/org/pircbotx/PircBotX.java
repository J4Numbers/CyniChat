...
import uk.co.CyniCode.CyniChat.libs.org.pircbotx.cap.CapHandler;
import uk.co.CyniCode.CyniChat.libs.org.pircbotx.cap.EnableCapHandler;
			...
			while ((line = breader.readLine()) != null) {
				...
				if (params.size() >= 2) {
					...
					if (Arrays.asList(codes).contains(code))
						...
						// No action required.
					} else if (capEnabled && code.equals("451") && params.get(0).equals("CAP")) {
